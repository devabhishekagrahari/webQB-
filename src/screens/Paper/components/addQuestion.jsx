    ...
    <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[80vh]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col space-y-4">
          ...
          {/* Sub Chapter */}
          <div>
            <label className="text-sm font-medium text-gray-700">Sub Chapter</label>
            <div className="flex gap-2 mt-1">
              <select
                name="subChapter"
          ...
          {/* Sub-Sub Chapter */}
          <div>
            <label className="text-sm font-medium text-gray-700">Sub-Sub Chapter</label>
            <div className="flex gap-2 mt-1">
              <select
                name="subSubChapter"
          ...
          {/* Type of Question */}
          <div>
            <label className="text-sm font-medium text-gray-700">Type of Question</label>
            <select
              name="typeOfQuestion"
